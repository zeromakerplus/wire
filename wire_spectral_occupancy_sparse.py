...
if __name__ == '__main__':
    nonlin = 'gauss' # type of nonlinearity, 'wire', 'siren', 'mfn', 'relu', 'posenc', 'gauss'
    ...
    spectral_dict_ind = [[58,93], [49,99],[39,108],[42,110],[52,108],[59,107],[65,98],[80,113],[101,109],[109,108], [117,110], [163,118],[172,108]]
    spectral_dict = np.zeros([len(spectral_dict_ind), 31])
    # plt.plot(spectral_img[spectral_dict_ind[i][0],spectral_dict_ind[i][1],:])
    ...
    im_mask = torch.rand(H*W*T,L, device='cuda') > 0.90
    # im_mask[:,:] = True
